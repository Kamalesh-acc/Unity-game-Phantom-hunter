...
public class BossHealth : MonoBehaviour
{
    ...
    public bosshealthbar1 healthbar1;
    ...
    void Update()
    {
        ...
        if (currentHealth <= 25  && spawnAnimationTriggered4)
        {
            ...
            bossfire.bulletSpeed = 19f;
            bossfire.shootInterval = 0.4f;
            bossspawnanim.activateSpawnAnim = 1;
            bossSpawn1.activateSpawn = 4;
        }
        if (currentHealth <= 50 && spawnAnimationTriggered3)
        {
            ...
            bossfire.bulletSpeed = 17f;
            bossfire.shootInterval = 0.4f;
            bossspawnanim.activateSpawnAnim = 1;
            bossSpawn1.activateSpawn = 3;
        }
        if (currentHealth <= 75 && spawnAnimationTriggered2)
        {
            ...
            bossfire.bulletSpeed = 14f;
            bossfire.shootInterval = 0.5f;
            bossspawnanim.activateSpawnAnim = 1;
            bossSpawn1.activateSpawn = 2;
        }
        if (currentHealth <= 90 && spawnAnimationTriggered)
        {
            ...
            bossfire.bulletSpeed = 12f;
            bossfire.shootInterval = 0.8f;
            bossspawnanim.activateSpawnAnim = 1;
            bossSpawn1.activateSpawn = 1;
        }
    }
