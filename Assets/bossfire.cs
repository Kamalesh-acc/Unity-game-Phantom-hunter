...
public class bossfire : MonoBehaviour
{
    ...
    private bool playerAlive = true; // Flag to track player's state
    ...
    void Update()
    {
        // Check if the player reference is assigned and the player is alive
    ...
    // Method to update player's state (e.g., when player dies)
